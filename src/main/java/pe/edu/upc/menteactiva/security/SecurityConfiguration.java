...
public class SecurityConfiguration {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests((auth) -> auth
                ...
                .requestMatchers(HttpMethod.DELETE, "/upc/MenteActiva/Appointments/eliminar/**").hasAnyAuthority(  "ROLE_ADMIN")
                .requestMatchers(HttpMethod.GET, "/upc/MenteActiva/Appointments/listartodos").hasAnyAuthority(  "ROLE_ADMIN")
                ...
                .requestMatchers(HttpMethod.GET, "/upc/MenteActiva/Chats/cliente/**").hasAnyAuthority( "ROLE_ADMIN")
                ...
                .requestMatchers(HttpMethod.GET, "/upc/MenteActiva/Professionals/listartodos").hasAnyAuthority( "ROLE_ADMIN")
                ...
                .requestMatchers(HttpMethod.GET, "/upc/MenteActiva/Schedules/listartodos").hasAnyAuthority( "ROLE_ADMIN")
                ...
                .requestMatchers(HttpMethod.DELETE, "/upc/MenteActiva/Video_Progress/registrar").hasAnyAuthority( "ROLE_ADMIN")
                .requestMatchers(HttpMethod.DELETE, "/upc/MenteActiva/Video_Progress/listartodos").hasAnyAuthority( "ROLE_ADMIN")
                .requestMatchers(HttpMethod.DELETE, "/upc/MenteActiva/Video_Progress/modificar/**").hasAnyAuthority( "ROLE_ADMIN")
                .requestMatchers(HttpMethod.DELETE, "/upc/MenteActiva/Video_Progress/eliminar/**").hasAnyAuthority( "ROLE_ADMIN")
                .requestMatchers(HttpMethod.DELETE, "/upc/MenteActiva/Videos/registrar").hasAnyAuthority( "ROLE_ADMIN",  "ROLE_PROFESSIONAL")
                .requestMatchers(HttpMethod.DELETE, "/upc/MenteActiva/Videos/listartodos").hasAnyAuthority( "ROLE_ADMIN")
                .requestMatchers(HttpMethod.DELETE, "/upc/MenteActiva/Videos/modificar/**").hasAnyAuthority( "ROLE_ADMIN", "ROLE_PROFESSIONAL")
                .requestMatchers(HttpMethod.DELETE, "/upc/MenteActiva/Videos/eliminar/**").hasAnyAuthority( "ROLE_ADMIN", "ROLE_PROFESSIONAL")
                .requestMatchers(HttpMethod.DELETE, "/upc/MenteActiva/Videos/VideosMasVistos/**").hasAnyAuthority( "ROLE_ADMIN")
                .requestMatchers(HttpMethod.DELETE, "/upc/MenteActiva/Videos/**/top-largos").hasAnyAuthority( "ROLE_ADMIN")
                .requestMatchers(HttpMethod.DELETE, "/upc/MenteActiva/Videos/**/count").hasAnyAuthority( "ROLE_ADMIN")
                .requestMatchers(HttpMethod.DELETE, "/upc/MenteActiva/Videos/search").hasAnyAuthority( "ROLE_ADMIN")
