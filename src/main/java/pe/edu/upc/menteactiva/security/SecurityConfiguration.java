...
public class SecurityConfiguration {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests((authz) -> authz
                ...
                .requestMatchers(HttpMethod.POST, "/upc/MenteActiva/Video_Progress/registrar").hasAnyAuthority( "ROLE_ADMIN")
                ...
                .requestMatchers(HttpMethod.PUT, "/upc/MenteActiva/Video_Progress/modificar/**").hasAnyAuthority( "ROLE_ADMIN")
